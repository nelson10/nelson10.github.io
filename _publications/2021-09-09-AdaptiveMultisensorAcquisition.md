...
Recommended citation: **N. Diaz**, J. Ramirez, E. Vera and H. Arguello, "Adaptive Multisensor Acquisition via Spatial Contextual Information for Compressive Spectral Image Classification" <i>IEEE Journal of Selected Topics in Applied Earth Observations and Remote Sensing,</i> vol. 14, pp. 9254-9266. 2021. [[TechRxiv]](http://nelson10.github.io/files/2021_JSTARS.pdf), [[DOI]](https://ieeexplore.ieee.org/document/9534664), [[Code]](https://github.com/nelson10/CompressiveAdaptiveClassificationMultisensor.).
