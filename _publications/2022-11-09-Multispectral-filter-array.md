...
Recommended citation: **N. Diaz**, A. Alvarado, P. Meza, F. Guzmán and E. Vera, "Multispectral Filter Array Design by Optimal Sphere Packing," <i> Summited to Transactions on Image Processing,</i> 2022. [[Paper]](https://nelson10.github.io/files/2022_IEEE_TIP.pdf), [[TechRxiv]](https://doi.org/10.36227/techrxiv.21502899.v1), [[Code]]([https://github.com/nelson10/DemosaickingMultispectral.git](https://github.com/nelson10/DemosaickingMultispectral3DSpherePacking.git)).
